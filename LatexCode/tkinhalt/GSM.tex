...
Nachdem festgestellt wurde, dass die USRP angeschlossen und vom System erkannt wurde, kann der eigentliche Versuch beginnen. Hierzu wird das Tool kal mit dem Kommando \glqq kal -s -DCS\grqq aufgerufen.

\subsubsection{Auswertung des Versuchs}
Das Tool kal hat angezeigt, dass folgende Frequenzen empfangen werden können:

\vspace{1 cm}
\begin{figure}[h!]
  \centering
  \includegraphics[width=1\textwidth]{tkinhalt/gsm_bilder/ergebnisKal.png}
  \caption{Darstellung aller empfangener Frequenzen}
  \label{fig:empfangeneFrequenzen}
\end{figure}


Bei dieser Tabelle fallen die Begriffe chan und power auf. Vor der eigentlichen Auswertung der Messergebnisse möchten wir diese Begriffe erst einmal erklären.
\paragraph{chan}
%%Keine Ahnung
...
Anhand dieser Auflistung ist es möglich, den Frequenzbereichs von DCS 1800 zu errechnen. DCS 1800 ist übrigens besser als das E Netz bekannt. 
