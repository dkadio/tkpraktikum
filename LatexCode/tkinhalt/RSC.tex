...
\todo{Entweder Ausgabe faken, oder trobleshooting beschreiben}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Line protocol is up %%%%%%%%Da mal checken, wie wir faken
		\item Internet address is 172.18.0.1/16 %%Hier auch
		\item Encapsulation ARPA
	\end{itemize}
	\item \textbf{To which OSI layer is the encapsulation referring?} see above
...
//Keine Ping Datei
\end{lstlisting}
\todo{Die Pings finde ich nicht. Evtl. müssen die mit nem Windows Rechner gefaket oder sonstwo abgeschrieben werden}