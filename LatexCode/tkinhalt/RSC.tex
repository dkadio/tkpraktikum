...
Das serielle Interface hat mittlerweile viel seiner Bedeutung verloren. Je nach Beschreibung des Herstellers wird eine maximale clock rate von 8 Mit/s angegeben. Die Glock rate entspricht auch der Übertragungsrate. Bei dieser Übertragungsrate scheint die serielle Schnittstelle neben Ethernet Ports unnötig zu sein. Dieser Eindruck täuscht, da diese Schnittstelle besonders bei leitungsvermittelnden Netzwerken ihre Vorteile hat. Wird für den Zugriff auf ein WAN keine besonders hohe Bitrate benötigt, sollte dafür auch die serielle Schnittstelle genutzt werden, da sie eine dedizierte Übertragung bereit stellt.
...
\begin{enumerate}
	...
	\item \textbf{What is the benefit of using port security?} The benefit of port security is a higher security in your network. It's possible to prohibit people to use their own devices. So you won't loose the responsibility the security for the devices. Also it is complicated to copy or steal data because you are able to configure the permitted devices with security policies. 
