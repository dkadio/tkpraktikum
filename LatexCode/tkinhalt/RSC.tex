...
\end{table}
\todo{IP erfinden oder rausfinden}
...
\begin{lstlisting}[captionpos=b, caption=Das Ergebnis des Pings von H1 zu Switch]
...
\todo{Keine Ahnung, welches Ergebnis}
...
\todo{Die Mac Adresse für Host 3 muss noch "gesucht" werden}
\begin{table}[h]
\begin{tabular}{|*{2}{c|}}
\hline
...
\todo{Fuck, hierfür gibt es keine Datei. Die sollten wir auftreiben oder aus der Versuchsbeschreibung kopieren} 
...
\todo{Was bedeutet das geht nicht in der Datei?} 
