...
\todo{Die Ausgabe von FE0/18 ist gefaked(Der Port wurde in Step10 nicht freigeschaltet). Vor Abgabe checken, ob das plausibel ist}
...
\end{table}
\todo{Die Zeile von FE0/18 kann aber auch falsch sein, weil das Interface down ist(Ich habe nur die erste Zeile manipuliert)}
...
\begin{enumerate}
	...
	\item \textbf{What is the benefit of using port security?} The benefit of port security is a higher security in your network. %%%Da weiterschreiben
\end{enumerate}