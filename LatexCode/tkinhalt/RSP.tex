...
\todo{Keine Ahnung, was der in Step 2 will}
...
\begin{itemize}
	...
	\item \textbf{Flash: } Der Flash Speicher beinhaltet bei Cisco Produkten ein Image oder mehrere Images des Betriebssystems. Der Flash Speicher beispielsweise genutzt, wenn das Betriebssystem des Routers neu aufgesetzt werden muss. Dies geschieht aus dem komprimierten Image vom Flash.
	...
	\item \textbf{ROM: } Der ROM speichert beispielsweise Informationen, die für den Selbsttest des Routers nötig sind. Für ein Software Update müssen die ROM Speichersteine ausgetauscht werden.
\end{itemize}
...
\todo{Noch die config Files vergleichen}
