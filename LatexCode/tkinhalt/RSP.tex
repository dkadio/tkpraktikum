...
Da die Änderungen sich nur auf den flüchtigen Speicher beschränken, gehen sie bei einem Neustart des Routers verloren. Dieser Tatsache kann durch das Kopieren des flüchtigen Speichers in den NVRAM. 

Bei der Gelegenheit ist zu erwähnen, dass ein Cisco Router verschiedene Sorten Speicher nutzt. Vor der Erklärung des nächsten Arbeitsschritts möchten wir diese kurz erläutern. Die Erläuterungen stammen von Cisco 
...
\bebin{itemize}
	...
	\item \textbf{NVRAM: } Der NVRAM beinhaltet das installierte Betriebssystem des Routers. Dort sind die Boot Konfigurationen gespeichert. Der Inhalt des NVRAMs geht nicht verloren, wenn der Router neu gestartet wird, oder durch einen Stromausfall unterversorgt wird. 