...
\begin{enumerate} 
	...
	\item \textbf{Welche Kodierung des Sprachkanals wird gewählt?}\newline
		...
		\includegraphics[scale=1]{ba_bilder/ba/itu_code.png} 
	...
	Die MSN des Teilnehmers auf der anderen Seite steht die MSN in dem Connect Rahmen. Diese ist ebenfalls im Abschnitt Q.931 unter Connected 		Number zu sehen.
		\includegraphics[scale=1]{ba_bilder/ba/connect_a5.png} 
	...
	\includegraphics[scale=1]{ba_bilder/ba/setup_acknoledge_a6.png} 
	...
	\includegraphics[scale=1]{ba_bilder/ba/call-proceeding_a7.png} 
	...
	\includegraphics[scale=1]{ba_bilder/ba/information_a8.png} 
	...
	\includegraphics[scale=1]{ba_bilder/ba/alerting_a9.png} 
	...
	\includegraphics[scale=1]{ba_bilder/ba/Release-Complete.png} 
...
Durch Abnehmen des Hörers wird für gewöhnlich eine Setup Nachricht gesendet wodurch bereits eine Verbindung zur Vermittlungsstelle aufgebaut wird. Nimmt der Teilnehmer also erst den Hörer ab können bereits die ersten Ziffern überliefert werden. Dieser Vorgang ist durch den Versuch gut nachvollziehbar. Im Gegensatz dazu kann der Nutzer ebenfalls die Ziffern erst tippen und dann den Hörer abnehmen. Dies hat zur Folge das die benötigten Ziffern bereits vorhanden sind bevor die Setup-Nachricht gesendet wird. Dadurch können die Ziffern direkt in der Setup-Nachricht mit gesendet werden. Der folgende Frame zeigt das bereits die Called-Party-Number eingetragen ist. Hier wird das Endgerät mit der Nummer 100 von dem Endgerät mir der Nummer 200 Angerufen. Der Frame wurde aufgrund der Größe etwas zugeschnitten, er enthält jedoch alle wichtigen Informationen.
	...
	\includegraphics[scale=1]{ba_bilder/ba/letzte_setup_block.png} 	
