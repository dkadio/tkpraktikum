...
Die Multiplexer sind mit Lichtwellenleiter verbunden die theoretisch eine Entfernung von gut 50Km schaffen würden. Da Elmi leider nicht von Siemens ist, ist es auch nicht möglich direkt über die Software zu sehen wie Elmi sich als Multiplexer verhält.
...
Die Aktualisierung der Daten findet nur manuell mit dem Update Knopf statt. TMP ist hier im Auge zu behalten da die Daten alle 15 Minuten in eine Log-Datei geschrieben werden und der Timer zurück gesetzt wird. Die Log-Dateien sind in den Reitern \textit{Previous 15min} und \textit{Previous 24h} wieder zu finden.
...
\item UAS - Nach 11 SES gilt eine Leitung als nicht mehr verfügbar. Nach 11 Sekunden ohne SES gilt die wieder als verfügbar.
