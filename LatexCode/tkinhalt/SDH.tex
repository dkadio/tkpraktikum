...
Eine weitere, für unseren Versuch wichtige, Funktion bietet die Sektion ALARM. Hier kann man nach Belieben Fehler ins Netz einspeisen. Diese kann man entweder als Pulse, das bedeutet über einen bestimmten Zeitrahmen, oder kontinuierlich setzen. 
\begin{figure}[H] 
	\centering
...
Wenn im empfangenen Signal Bitfehler enthalten sind, sendet der Empfänger eine Alarm-Nachricht in Senderichtung zurück. Bei dieser Rückmeldung spricht man von REI (Remote Error Indication). Die für uns wichtigen sind:
