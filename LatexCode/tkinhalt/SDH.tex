...
\includegraphics[scale=1]{tkinhalt/sdh/versuchsaufbau.png}
...
\includegraphics[scale=1]{tkinhalt/sdh/elmi_start.png}
...
\includegraphics[scale=1]{tkinhalt/sdh/elmi_fehler.png}
...
\includegraphics[scale=1]{tkinhalt/sdh/tnms.jpg}
...
\includegraphics[scale=1]{tkinhalt/sdh/Fehler2.jpg}
...
\includegraphics[scale=1]{tkinhalt/sdh/komponent-performance.jpg}
...
\includegraphics[scale=1]{tkinhalt/sdh/Pointerview_detail.jpg}
...
\includegraphics[scale=1]{tkinhalt/sdh/ms-near-end.jpg}
...
\todo{Ich habe den Fehler auskommentiert}
\end{itemize}
...
\includegraphics[scale=1]{tkinhalt/sdh/stm1-konti.jpg}
...
\hline
\end{tabular}
\caption{Irgend eine Unterschrift}
\end{table}
\todo{Caption der Table ändern}
...
\includegraphics[scale=1]{tkinhalt/sdh/IMG_1937.JPG}
